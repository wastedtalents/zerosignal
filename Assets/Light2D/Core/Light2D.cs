...
public class Light2D : MonoBehaviour
{
    ...
    void CollectColliders()
    {
        if (lightType != LightTypeSetting.Directional)
        {
            ...
            #if !(UNITY_2_6 || UNITY_2_6_1 || UNITY_3_0 || UNITY_3_0_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2)
            objs._2DColliders = Physics2D.OverlapAreaAll(transform.position - renderer.bounds.extents, transform.position + renderer.bounds.extents, shadowLayer); //Physics2D.OverlapAreaAll(transform.position + new Vector3(-lightRadius, lightRadius, 0), transform.position + new Vector3(lightRadius, -lightRadius, 0), shadowLayer);
            #endif
        }
        else
        {
